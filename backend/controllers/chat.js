...
const getChat = async (req, res) => {
	...
	// 	const decryptedChats = chat.map(chat => {
	// 	if (chat.latestMessage && chat.latestMessage.message) {
	// 		try {
	// 			chat.latestMessage.message = decrypt(chat.latestMessage.message);
	// 			console.log("Decrypted message:", chat.latestMessage.message);	
	// 		} catch (err) {
	...
	// 	return chat;
	// });
	// console.log("Decrypted Chats:", decryptedChats.latestMessage.message);
	return res.status(200).json({ data: chat });
};
